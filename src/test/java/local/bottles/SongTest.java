...
public class SongTest {
    ...
    public void testTheFirstVerse() {
        ...
        Assert.assertEquals(expected, subject().verse(99));
    }
    ...
    public void testVerse3() {
        ...
        Assert.assertEquals(expected, subject().verse(3));
    }
    ...
    public void testVerse2() {
        ...
        Assert.assertEquals(expected, subject().verse(2));
    }
    ...
    public void testVerse1() {
        ...
        Assert.assertEquals(expected, subject().verse(1));
    }
    ...
    public void testVerse0() {
        ...
        Assert.assertEquals(expected, subject().verse(0));
    }
    ...
    public void testAFewVerses() {
        ...
        Assert.assertEquals(expected, subject().verses(2, 0));
    }
    ...
    public void testTheWholeSong() {
        ...
        Assert.assertEquals(expected, subject().whole());
    }
